...
from lara_full.model.transforms import DefaultDataCollator
from lara_full.utils.experiment import (
    CheckpointFormatCallback,
    safe_save_model_for_hf_trainer,
)
from lara_full.experiment.arguments import BaseArguments
    ...
    def __init__(
        ...
        if report_to == "wandb":
            ...
            if "WANDB_PROJECT" not in os.environ:
                os.environ["WANDB_PROJECT"] = "lara_full-training"
...
class BaseRunner(TrainRunner):
    def __init__(
        self,
        model: torch.nn.Module,
        training_args: TrainingArguments,
        extra_args: BaseArguments,
