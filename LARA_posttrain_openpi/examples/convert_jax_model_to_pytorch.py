...
Example:
    # pi0_droid
    python examples/convert_jax_model_to_pytorch.py --checkpoint_dir <path-to-pi0-droid-checkpoint> --output_path <output-directory>

    # pi0_aloha_sim
    python examples/convert_jax_model_to_pytorch.py --checkpoint_dir <path-to-pi0-aloha-checkpoint> --output_path <output-directory>

    # pi05_droid
    python examples/convert_jax_model_to_pytorch.py --checkpoint_dir <path-to-pi05-droid-checkpoint> --output_path <output-directory>
"""
